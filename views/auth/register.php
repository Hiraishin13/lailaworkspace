...
<body>
    ...
    <div class="auth-container">
        <div class="auth-card">
            ...
            <p>Créez votre compte Laila Workspace</p>
            ...
            <form action="register.php" method="POST" id="registerForm">
                ...
                <div class="form-actions mb-3">
                    <button type="button" class="btn btn-light w-100 mb-2" style="border:1px solid #e9ecef; display:flex; align-items:center; justify-content:center; gap:8px;">
                        <img src='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/google/google-original.svg' alt="Google" style="width:20px; height:20px;"> S'inscrire avec Google
                    </button>
                    <button type="button" class="btn btn-light w-100 mb-3" style="border:1px solid #e9ecef; display:flex; align-items:center; justify-content:center; gap:8px;">
                        <img src='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/apple/apple-original.svg' alt="Apple" style="width:20px; height:20px;"> S'inscrire avec Apple
                    </button>
                </div>
