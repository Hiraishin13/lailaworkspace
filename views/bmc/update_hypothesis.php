...
if (!isset($_POST['hypothesis_id']) || !is_numeric($_POST['hypothesis_id']) || !isset($_POST['hypothesis_text']) || empty(trim($_POST['hypothesis_text']))) {
...
try {
    ...
    // Mettre à jour le texte de l'hypothèse
    $stmt = $pdo->prepare("UPDATE hypotheses SET hypothesis_text = :hypothesis_text WHERE id = :id");
    $stmt->execute([
